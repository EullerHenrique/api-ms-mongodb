...
import com.api.ms.mongodb.domain.dto.responses.MultipleDataResponseMessage;
import com.api.ms.mongodb.domain.dto.responses.SingleDataResponseMessage;
...
import com.api.ms.mongodb.domain.view.Views;
import com.api.ms.mongodb.service.empresa.EmpresaService;
import com.api.ms.mongodb.service.token.TokenService;
...
/*
    ...
    public SingleDataResponseMessage adicionarToken(@PathVariable String id, @RequestHeader Map<String, String> headers, @RequestBody Map<String, String> grants) {
...
*/
    ...
    @GetMapping(value = "/{id}")
    public SingleDataResponseMessage findById(@RequestHeader Map<String, String> headers, @PathVariable String id) {
